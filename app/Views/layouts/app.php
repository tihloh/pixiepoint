...
<head>
    ...
    <!-- Keep the essential PixiePoint background local and immediate even if a stylesheet request is delayed. -->
    <style>
        html,body{min-height:100%;background:#07111f}body{margin:0;background:radial-gradient(circle at 10% 0,#302265 0,transparent 31rem),#07111f}
    </style>
    ...
    >
    <!-- PixiePoint is deliberately last: Bootstrap owns components; these files only theme them. -->
    <link rel="stylesheet" href="/assets/app.css?v=<?= e($cssVersion) ?>">
...
<body>
            ...
            <div class="container-xl py-1">
                ...
                <div class="collapse navbar-collapse" id="pixiepoint-nav">
                    <div class="navbar-nav ms-auto align-items-lg-center gap-lg-1 py-2 py-lg-0">
                        ...
                        <?php if ($access['users'] ?? false): ?><a class="nav-link" href="/admin/users">Users</a><?php endif; ?>
                        <?php if ($access['groups'] ?? false): ?><a class="nav-link" href="/admin/groups">Groups</a><?php endif; ?>
                        ...
                        <?php if ($access['sales'] ?? false): ?><a class="nav-link" href="/admin/sales">Sales</a><?php endif; ?>
                        <?php if ($access['logs'] ?? false): ?><a class="nav-link" href="/admin/logs">Logs</a><?php endif; ?>
    ...
    <?php endif; ?>
    <main class="<?= $dashboard ? 'container-xl py-4 py-lg-5' : 'portal container-fluid' ?>"><?= $content ?></main>
