...
<div class="context">
    <div><small>Device</small><?= e($context['mac'] ?: 'Private/randomized identity') ?></div>
...
<form method="post" action="/hotspot/authenticate">
    ...
    <div class="field">
        ...
        <input id="voucher" name="voucher" autocomplete="one-time-code" autocapitalize="characters" required autofocus>
    </div>
...
<?php else: ?>
<p class="muted">Guest access works normally. <a href="/">Log in</a> or <a href="/register">register</a> to protect your points and device history.</p>
<?php endif; ?>
