...
<div class="text-end mb-3">
    <button class="btn btn-link btn-sm text-body-secondary" type="button" id="register-router-button" data-bs-toggle="modal" data-bs-target="#register-router-modal">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <textarea id="router-registration-command" class="form-control font-monospace" rows="6" readonly><?= e($routerRegistrationCommand) ?></textarea>
            </div>
