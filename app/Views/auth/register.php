...
<p class="muted">Register a member account for your points, devices and account-linked Wi-Fi activity.</p>
...
<form method="post" class="auth-form">
    ...
    <div class="field">
        ...
        <small class="text-body-secondary">Choose at least 8 characters to protect your account.</small>
    </div>
    <button class="button full">Create account</button>
    <small class="d-block text-body-secondary mt-2">Creates a member account and signs you in.</small>
</form>
