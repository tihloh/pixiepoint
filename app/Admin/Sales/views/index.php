...
<div class="heading">
    <div>
        <h1>Sales</h1>
        <p class="muted">Sales, extensions and points from <strong><?= e($router['name']) ?></strong> <span class="text-body-secondary">· <?= e($router['identity']) ?></span></p>
    </div>
</div>
...
<section class="panel">
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle">
            <thead><tr><th>Time</th><th>Router</th><th>Voucher</th><th>Device</th><th>Type</th><th>Amount</th><th>Points</th></tr></thead>
            <tbody>
                <?php if (!$events): ?><tr><td colspan="7" class="empty">No sales recorded.</td></tr><?php endif; ?>
