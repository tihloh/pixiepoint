        ...
        <tbody>
            ...
            <?php foreach ($events as $event): ?>
                <tr>
                    ...
                    <td class="code"><?= e($event['username']) ?></td>
                    <td class="code">
                        <?= e($event['device_mac'] ?: $event['mac'] ?: '—') ?>
                    </td>
                    <td><?= $event['is_extension'] ? 'Extension' : 'New access' ?></td>
                    <td>₱<?= e(number_format((int) $event['amount_pesos'])) ?></td>
