...
final class Controller extends FeatureController
{
    ...
    public function index(): never
    {
        ...
        if($this->isPost()){$this->handlePost($access,$userId,$platformOwner,$routerId);$return=trim((string)($_POST['return_to']??''));if($return==='/admin/routers'||preg_match('~^/admin/routers/\d+(?:#stations)?$~',$return))redirect($return);redirect('/admin/routers/'.$routerId.'#stations');}
