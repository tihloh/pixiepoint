                    ...
                    <div class="col-12">
                        <div class="border rounded p-3">
                            <div class="d-flex flex-column flex-md-row justify-content-between gap-2 mb-3">
                                ...
                                <div class="text-md-end"><div><strong>Installed:</strong> v<?= e(ltrim($currentFirmware,'vV')) ?></div><div><strong>Latest:</strong> <span data-firmware-latest><?= $latestFirmware!==''?'v'.e(ltrim($latestFirmware,'vV')):'Unknown' ?></span></div></div>
                            </div>
                            ...
                            <form method="post" class="row g-3 align-items-end js-vendo-form"><input type="hidden" name="_csrf" value="<?= e(csrf_token()) ?>"><input type="hidden" name="device_id" value="<?= e($deviceId) ?>"><input type="hidden" name="action" value="save_firmware">
                                <div class="col-sm-6 col-lg-3"><div class="form-check form-switch"><input class="form-check-input" type="checkbox" role="switch" name="auto_check" id="fw-check-<?= $i ?>" <?= ($fwConfig['auto_check']??true)?'checked':'' ?>><label class="form-check-label" for="fw-check-<?= $i ?>">ESP automatic checks</label></div></div>
