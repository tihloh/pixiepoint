            ...
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="team-email" type="email" name="email" autocomplete="off" required>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        ...
                        <form method="post" class="d-inline">
                            ...
                            <button class="btn btn-sm btn-outline-danger" type="submit" onclick="return confirm('Remove this team member?')">
                                Remove
                            </button>
                        </form>
                        <?php endif; ?>
