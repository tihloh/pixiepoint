            ...
            <tbody>
                <?php foreach ($vendos as $v): ?>
                    <tr>
                        ...
                        <td class="code"><?= e(preg_replace('~^https?://~i','',$v['base_url'])) ?></td>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable"><div class="modal-content"><form method="post">
        ...
        <div class="modal-body"><input type="hidden" name="_csrf" value="<?= e($csrf) ?>"><input type="hidden" name="action" value="create"><input type="hidden" name="id" value="0">
            <div class="row g-3">
                ...
                <div class="col-md-6"><div class="form-check"><input class="form-check-input" type="checkbox" name="charging_enabled" value="1" id="vendo-charging"><label class="form-check-label" for="vendo-charging">Phone charging</label></div></div>
                <div class="col-md-6"><div class="form-check"><input class="form-check-input" type="checkbox" name="eload_enabled" value="1" id="vendo-eload"><label class="form-check-label" for="vendo-eload">E-load</label></div></div>
                <div class="col-md-6" id="vendo-enabled-wrap" hidden><div class="form-check"><input class="form-check-input" type="checkbox" name="enabled" value="1" id="vendo-enabled"><label class="form-check-label" for="vendo-enabled">Enabled</label></div></div>
            </div>
        </div>
