                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <?php else: ?>
                                    <div
                                        class="rounded-circle border d-flex align-items-center justify-content-center fw-bold"
                        ...
                        <td>
                            <span class="badge off">
                                <?= e(ucwords(str_replace('_', ' ', (string) ($user['platform_role'] ?? 'member')))) ?>
                            </span>
                        </td>
                        <td>
                            <span class="badge <?= !empty($user['active']) ? '' : 'off' ?>">
                                <?= !empty($user['active']) ? 'Active' : 'Disabled' ?>
                            </span>
                        </td>
                        ...
                        <td class="text-end text-nowrap">
                            ...
                            <?php if ($canManagePermissions): ?>
                                <a
                                    ...
                                    href="/admin/users/<?= e($user['id']) ?>/permissions"
                                >
                                    Permissions
                                </a>
                            <?php endif; ?>
