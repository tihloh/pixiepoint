...
<div class="heading">
    ...
    <div class="d-flex gap-2 flex-wrap"><?php if ($canManageGroups) :
    ?><a class="btn btn-sm btn-outline-secondary" href="/admin/groups">Groups</a><?php endif; ?><?php if ($canManage) :
    ?><button class="btn btn-sm btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#addUserModal">Add user</button><?php endif; ?></div>
</div>
<?= $message ?>
<section class="panel">
    ...
    ?><a class="btn btn-sm btn-outline-primary" href="/admin/users/<?= e($user['id']) ?>/permissions">Permissions</a><?php endif; ?></td>
                </tr><?php endforeach; ?>
            </tbody>
        </table>
    </div>
