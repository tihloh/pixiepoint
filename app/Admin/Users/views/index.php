...
<div class="heading">
    <div>
        <h1>Users</h1>
        <p class="muted">Manage PixiePoint users, roles and access.</p>
    </div>

    <div class="d-flex gap-2 flex-wrap">
        <?php if ($canManageGroups): ?>
            <a class="btn btn-sm btn-outline-secondary" href="/admin/groups">Groups</a>
        <?php endif; ?>
        <?php if ($canManage): ?>
            <button class="button" type="button" data-bs-toggle="modal" data-bs-target="#addUserModal">Add user</button>
        <?php endif; ?>
    </div>
</div>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                <?php if (!empty($user['avatar_url'])): ?>
                                    <img src="<?= e($user['avatar_url']) ?>" alt="" width="36" height="36" class="rounded-circle object-fit-cover border flex-shrink-0">
                                <?php else: ?>
                                    <div class="rounded-circle border d-flex align-items-center justify-content-center fw-bold flex-shrink-0" style="width:36px;height:36px">
