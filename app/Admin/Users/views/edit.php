        ...
        <section class="panel p-0 overflow-hidden">
            ...
            <div class="p-4">
                ...
                <div class="d-flex align-items-center gap-3 mb-4">
                    ...
                    <?php else: ?>
                        <div
                            class="rounded-circle border d-flex align-items-center justify-content-center fs-4 fw-bold"
                        ...
                        <div class="col-md-6">
                            ...
                            <?php else: ?>
                                <select class="form-select" id="user-role" name="platform_role">
                                    <option value="member" <?= ($user['platform_role'] ?? '') === 'member' ? 'selected' : '' ?>>
                                        Member
                                    </option>
                                    <option value="pisowifi_owner" <?= ($user['platform_role'] ?? '') === 'pisowifi_owner' ? 'selected' : '' ?>>
                                        PisoWiFi Owner
                                    </option>
                                </select>
                            <?php endif; ?>
