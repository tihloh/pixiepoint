(function() {
  ...
  fetch(url, {
    ...
    document.body.innerHTML = '<main style="font-family:sans-serif;padding:24px;max-width:560px;margin:auto"><h1>PixiePoint unavailable</h1><p>The hosted portal could not be loaded.</p><p><small>' + String(error.message || error).replace(/[&<>"']/g, function(c) {
      return ({
        '&': '&amp;',
        '<': '&lt;',
        '>': '&gt;',
