(function () {
    ...
    <main class="portal">
      <section class="card">
        ...
        <div id="pp-extend-box" class="compat-transaction" hidden>
          <p id="pp-extend-status" class="muted">Insert coins to add time to your current voucher.</p>
  ...
  function pollExtension() {
    ...
    request("/checkCoin", "POST", { voucher: session.username })
      ...
      .catch(function () {
        document.getElementById("pp-extend-status").textContent = "Waiting for the coin slot…";
